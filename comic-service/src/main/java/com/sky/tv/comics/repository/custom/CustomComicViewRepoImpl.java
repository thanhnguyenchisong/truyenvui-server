...
public class CustomComicViewRepoImpl implements CustomComicViewRepo {
  ...
  @Override
  public List<ComicAnalysis> getComicAnalysisByView(String startDate, String endDate,
      int limit) { //will test after
    ...
    return entityManager.createQuery(query, ComicAnalysis.class).setMaxResults(limit)
        .getResultList();
  }
